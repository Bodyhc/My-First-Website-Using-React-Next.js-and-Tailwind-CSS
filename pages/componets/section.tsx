          ...
          <div className="flex flex-col justify-between lg:flex-row">
            <div className="mb-12 lg:max-w-lg lg:pr-5 lg:mb-0">
              ...
              <div className="flex">
                <a href="" aria-label="Play Song" className="mr-3">
                  <div className="flex items-center justify-center w-10 h-10 text-white transition duration-300 transform rounded-full shadow-md bg-purple-700 hover:bg-purple-700 hover:scale-110">
                    <svg
                      className="w-6"
                      fill="currentColor"
                      viewBox="0 0 24 24">
            ...
            <div className="px-5 pt-6 pb-5 text-center border border-gray-300 rounded lg:w-2/5">
              ...
              <div className="flex justify-center w-full mb-3">
                <a
                  href=""
                  className="inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md md:w-auto bg-purple-700 hover:bg-purple-700 focus:shadow-outline focus:outline-none">
